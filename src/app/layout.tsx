...
export const metadata: Metadata = {
  title: {
    default:
      "X2M Creative - Creatività e Strategia per la Crescita del Tuo Brand",
    template: "%s | X2M Creative",
  },
  description:
    "X2M Creative combina creatività e strategia per far crescere il tuo brand in modo misurabile. Servizi di branding, social media strategy, video making e advertisement per aziende che vogliono distinguersi.",
  keywords: [
    "branding",
    "creative agency",
  ...
  openGraph: {
    ...
    title:
      "X2M Creative - Creatività e Strategia per la Crescita del Tuo Brand",
    description:
      "X2M Creative combina creatività e strategia per far crescere il tuo brand in modo misurabile. Servizi di branding, social media strategy, video making e advertisement.",
    images: [
      {
        url: "/img/X2M.png",
        width: 1200,
  ...
  twitter: {
    ...
    title:
      "X2M Creative - Creatività e Strategia per la Crescita del Tuo Brand",
    description:
      "X2M Creative combina creatività e strategia per far crescere il tuo brand in modo misurabile.",
    images: ["/img/X2M.png"],
  },
  alternates: {
...
export default function RootLayout({
  ...
  return (
    <html
      lang="it"
      className={`${raleway.variable} ${instrument_serif.variable}`}
    >
      <head>
