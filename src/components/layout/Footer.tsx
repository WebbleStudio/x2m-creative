export default function Footer() {
  return (
    <footer
      className="bg-[#131313] text-main-white py-8 px-4 mt-16 border-t border-white/20"
      role="contentinfo"
    >
      <div className="max-w-5xl mx-auto">
        {/* Main footer content */}
        <div className="flex items-center justify-center gap-6 sm:gap-12">
          {/* Left section - X2 Marco */}
          <div className="flex flex-col items-center min-[410px]:flex-row min-[410px]:items-end gap-2 min-[410px]:gap-4">
            <div className="flex flex-col items-center min-[410px]:items-start">
              <span className="text-sm text-white/70 leading-none mb-2">
                Owner
              </span>
              <address className="not-italic">
                <span
                  className="text-2xl font-bold tracking-tight text-white leading-none block"
                  itemScope
            ...
            {/* X2 Marco Social Links */}
            <div
              className="flex items-center justify-center min-[410px]:items-end gap-3 pb-[2px] mt-3 min-[410px]:mt-0 min-[410px]:pb-[2px]"
              role="list"
              aria-label="Social media X2M Creative"
            >
              <a
                ...
                className="hover:text-creative-blue transition-colors w-[18px] h-[18px] flex items-center justify-center"
                role="listitem"
              >
                <svg
                  width="18"
          ...
          {/* Vertical divider */}
          <div
            className="self-stretch min-[410px]:h-12 w-px bg-white/20"
            role="separator"
            aria-hidden="true"
          />

          {/* Right section - Webble Studio */}
          <div className="flex flex-col items-center min-[410px]:flex-row min-[410px]:items-end gap-2 min-[410px]:gap-4">
            <div className="flex flex-col items-center min-[410px]:items-start">
              <span className="text-sm text-white/70 leading-none mb-2">
                Made by
              ...
              <div itemScope itemType="https://schema.org/Organization">
                ...
                >
                  <img
                    ...
                    className="h-4 w-auto mt-[5px] mb-[5px]"
                    itemProp="logo"
                  />
                </a>
            ...
            <div
              className="flex items-center justify-center min-[410px]:items-end gap-3 pb-[2px] mt-3 min-[410px]:mt-0 min-[410px]:pb-[2px]"
              role="list"
              aria-label="Social media Webble Studio"
            >
              <a
        ...
        <div className="text-center mt-8">
          ...
          >
            © 2025 <span itemProp="name">X2M Creative</span>. Tutti i diritti
            riservati.
            <span className="sr-only">
              Agenzia creativa specializzata in branding, social media strategy,
              video making e advertisement per la crescita del brand.
            </span>
          </p>
        </div>
      </div>
