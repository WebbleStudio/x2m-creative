export default function Contact() {
  return (
    <section id="contact" className="min-h-[700px] md:h-screen lg:min-h-[850px] xl:min-h-[900px] 2xl:min-h-[1100px] bg-main-black text-main-white flex flex-col items-center justify-center">
      <div className="mb-8 text-center lg:hidden">
        <h2 className="text-white text-4xl md:text-5xl font-raleway leading-tight">
      ...
      <div
        className="w-full aspect-square sm:aspect-auto sm:h-auto sm:min-h-[320px] md:min-h-[420px] lg:min-h-[550px] 2xl:min-h-[700px] rounded-3xl flex items-center justify-center mx-auto bg-cover bg-left relative"
        style={{ backgroundImage: "url('/img/contact-us.png')" }}
      >
        {/* Overlay gradiente nero-trasparente dal basso verso l'alto */}
        <div className="absolute inset-0 rounded-3xl pointer-events-none bg-gradient-to-t from-black/60 to-transparent" />
        
        {/* Box email nella parte bassa - nascosto su lg */}
        <form action="https://formspree.io/f/xblkjlwv" method="POST" className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[90%] block lg:hidden">
          <div className="w-full bg-white/90 rounded-2xl flex items-center justify-center px-4 py-3 shadow-lg">
            ...
            />
            <button type="submit" className="ml-2 flex items-center justify-center bg-black hover:bg-neutral-900 text-white rounded-xl px-4 py-2 transition-all duration-200">
        ...
        <div className="hidden lg:flex flex-col justify-center absolute right-6 top-6 bottom-6 w-1/2 bg-[#fafafa] bg-opacity-70 rounded-2xl backdrop-blur-sm p-12">
          ...
          <form action="https://formspree.io/f/xblkjlwv" method="POST" className="w-full">
            <div className="flex items-center">
              ...
              />
              <button type="submit" className="ml-2 flex items-center justify-center bg-black hover:bg-neutral-900 text-white rounded-xl px-5 py-4 transition-all duration-200">
