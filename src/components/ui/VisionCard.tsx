...
import RedlineReveal from '../animations/RedlineReveal'; // Import the new animation component
import ScaleOnActive from '../animations/ScaleOnActive'; // Import ScaleOnActive
import TranslateOnActive from '../animations/TranslateOnActive'; // Import TranslateOnActive
